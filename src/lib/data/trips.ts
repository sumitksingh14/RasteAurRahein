...
export const DEMO_TRIPS: Trip[] = [
  ...
  },
  {
    ...
    excerpt: "Climb to 11,500 ft on Khaliya Bugyal for India's most dramatic and accessible high-altitude panorama of Panchachuli, Nanda Devi, and Rajrambha — with seamless flight connections from Mumbai or Pune via Pantnagar.",
    ...
    itinerary: [
      {
        _key: "kht-d1",
        dayNumber: 1,
        title: "Mumbai/Pune → Pantnagar/Kathgodam → Almora → Thal / Chaukori",
        date: undefined,
        ...
        activities: [
          { _key: "kht1a", title: "Flight BOM/PNQ to Pantnagar (2h 15m)", description: "Direct or one-stop morning connection to Pantnagar Airport (PGH) nestled in the Terai plains.", location: { name: "Pantnagar Airport", lat: 29.0322, lng: 79.4736 }, type: "transport" },
          { _key: "kht1b", title: "Drive through Almora & Bageshwar (~190 km, 6 hrs)", description: "Scenic mountain road along terrace farms, crossing Almora and Bageshwar riverside temples.", location: { name: "Almora", lat: 29.5971, lng: 79.6586 }, type: "transport" },
          { _key: "kht1c", title: "Overnight by Ramganga at Thal", description: "Quiet rest in the Ramganga valley to break the long journey and ensure proper acclimatization.", location: { name: "Thal, Uttarakhand", lat: 29.8333, lng: 80.1333 }, type: "accommodation" },
        ],
      },
      {
        _key: "kht-d2",
        ...
        activities: [
          { _key: "kht2a", title: "Birthi Falls Photography Stop", description: "A dramatic 126-meter waterfall cascading through alpine cedar cliffs with mist spraying the highway.", location: { name: "Birthi Falls", lat: 29.9833, lng: 80.1167 }, type: "sightseeing" },
          { _key: "kht2b", title: "Arrive in Munsiyari & Bhotiya Village Walk", description: "Check in at Sarmoli village homestays. Stroll through traditional stone houses and visit the Bhotiya Tribal Museum.", location: { name: "Munsiyari", lat: 30.0668, lng: 80.2377 }, type: "activity" },
          { _key: "kht2c", title: "Trek Briefing & Gear Check", description: "Meet your local mountain guide, check crampons/poles for Khaliya Bugyal, and feast on traditional Bhatt ki Churkani.", location: { name: "Sarmoli Village", lat: 30.0712, lng: 80.2410 }, type: "food" },
        ],
      },
      {
        _key: "kht-d3",
        ...
        activities: [
          { _key: "kht3a", title: "Drive to Balanti Trailhead (9 km, 20 mins)", description: "Transfer by gypsy to the Khaliya Top entry gate at Balanti bend.", location: { name: "Balanti Bend", lat: 30.0740, lng: 80.2290 }, type: "transport" },
          { _key: "kht3b", title: "Trek to Khaliya Meadow (6 km, 4 hrs, +3,500 ft)", description: "Gradual to steep trail traversing ancient rhododendron woodlands alive with Himalayan Monal birds.", location: { name: "Khaliya Bugyal", lat: 30.0785, lng: 80.2215 }, type: "activity" },
          { _key: "kht3c", title: "Camp Setup & Panchachuli Sunset", description: "Watch the massive granite spires of Panchachuli I–V turn from blazing gold to crimson under a violet sky.", location: { name: "Khaliya Top Camp", lat: 30.0785, lng: 80.2215 }, type: "accommodation" },
        ],
      },
      {
        _key: "kht-d4",
        ...
        activities: [
          { _key: "kht4a", title: "Dawn Push to Zero Point (2 km, 1.5 hrs)", description: "Scramble along the exposed grassy crest to the summit cairn at 3,700 meters.", location: { name: "Khaliya Zero Point", lat: 30.0833, lng: 80.2180 }, type: "activity" },
          { _key: "kht4b", title: "360-Degree Himalayan Sunrise", description: "Unrivaled panoramic vantage revealing Nanda Devi (7,816 m), Hardeol, Nanda Kot, and Api Himal across Nepal.", location: { name: "Khaliya Zero Point", lat: 30.0833, lng: 80.2180 }, type: "sightseeing" },
          { _key: "kht4c", title: "Descent to Balanti & Drive to Munsiyari", description: "Hike back down through the pine glades, savor hot lunch at Monal Cafe, and enjoy a warm shower.", location: { name: "Munsiyari", lat: 30.0668, lng: 80.2377 }, type: "accommodation" },
        ],
      },
      {
        _key: "kht-d5",
        ...
        activities: [
          { _key: "kht5a", title: "Drive Munsiyari to Kathgodam/Pantnagar (~270 km, 8–9 hrs)", description: "Descent through scenic Kumaon valleys with a farewell stop for steaming chai and pahadi pakoras.", location: { name: "Kathgodam", lat: 29.2730, lng: 79.5447 }, type: "transport" },
          { _key: "kht5b", title: "Evening Flight / Train to BOM / PNQ", description: "Board evening flight from Pantnagar or Kathgodam Shatabdi to Delhi with connecting flight home.", location: { name: "Pantnagar Airport", lat: 29.0322, lng: 79.4736 }, type: "transport" },
        ],
      },
    ],
  },
    ...
    itinerary: [
      {
        ...
        activities: [
          { _key: "ckt1a", title: "Flight BOM/PNQ to Dehradun Airport (2h 10m)", description: "Direct morning flight landing at Jolly Grant Airport with immediate cab transfer.", location: { name: "Dehradun Airport", lat: 30.1897, lng: 78.1803 }, type: "transport" },
          { _key: "ckt1b", title: "Drive to Chakrata via Vikasnagar (~115 km, 3.5 hrs)", description: "Smooth ascent winding along emerald terraced valleys and towering Himalayan cedar trees.", location: { name: "Chakrata", lat: 30.7016, lng: 77.8698 }, type: "transport" },
          { _key: "ckt1c", title: "Evening Walk on Sadar Bazaar Ridge", description: "Quiet stroll past colonial stone bungalows, cantonment churches, and mountain bakeries.", location: { name: "Sadar Bazaar, Chakrata", lat: 30.7016, lng: 77.8698 }, type: "activity" },
        ],
      },
      {
        _key: "ckt-d2",
        ...
        activities: [
          { _key: "ckt2a", title: "Trek to Tiger Falls (5 km downhill, 2 hrs)", description: "Picturesque forest trail passing terraced cornfields and clear mountain streams.", location: { name: "Tiger Falls Trail", lat: 30.7180, lng: 77.8820 }, type: "activity" },
          { _key: "ckt2b", title: "Swim & Refresh at Tiger Falls Pool", description: "Witness the thundering 312 ft single-drop waterfall cascading into an emerald natural pool.", location: { name: "Tiger Falls", lat: 30.7225, lng: 77.8864 }, type: "sightseeing" },
          { _key: "ckt2c", title: "Jaunsari Cultural Lunch & Village Visit", description: "Savor Gahat ki Dal and Cholu rotis at Chaupal Rasoi, visiting centuries-old carved timber houses.", location: { name: "Jaunsar Bawar Village", lat: 30.7100, lng: 77.8750 }, type: "food" },
        ],
      },
      {
        _key: "ckt-d3",
        ...
        activities: [
          { _key: "ckt3a", title: "4x4 Jeep Safari to Deoban (13 km, 1 hr)", description: "Rough dirt track winding through dense virgin deodars and alpine meadows at 2,870 m.", location: { name: "Deoban Forest", lat: 30.7483, lng: 77.8786 }, type: "activity" },
          { _key: "ckt3b", title: "55 Peak Viewpoint Hike", description: "Spectacular vantage point offering uninterrupted views of Swargarohini, Bandarpoonch, and Chaukhamba.", location: { name: "Vyas Shikhar, Deoban", lat: 30.7510, lng: 77.8810 }, type: "sightseeing" },
          { _key: "ckt3c", title: "Sunset at Chilmiri Neck", description: "Flat grassy plateau offering the grandest sunset in the Jaunsar region over rolling ridges.", location: { name: "Chilmiri Neck", lat: 30.6930, lng: 77.8590 }, type: "activity" },
        ],
      },
      {
        _key: "ckt-d4",
        ...
        activities: [
          { _key: "ckt4a", title: "Ashokan Rock Edict at Kalsi", description: "UNESCO-tentative quartz rock inscribed in Prakrit Brahmi script by Emperor Ashoka in 250 BC.", location: { name: "Ashokan Edicts, Kalsi", lat: 30.5312, lng: 77.8520 }, type: "sightseeing" },
          { _key: "ckt4b", title: "Transfer to Dehradun Airport (~85 km, 2.5 hrs)", description: "Drive along the Doon Valley highway to Jolly Grant Airport.", location: { name: "Dehradun Airport", lat: 30.1897, lng: 78.1803 }, type: "transport" },
          { _key: "ckt4c", title: "Flight to Mumbai (BOM) / Pune (PNQ)", description: "Board evening flight landing back in Mumbai or Pune with timeless mountain memories.", location: { name: "Mumbai Airport", lat: 19.0896, lng: 72.8656 }, type: "transport" },
        ],
      },
    ],
  },
    ...
    itinerary: [
      {
        ...
        activities: [
          { _key: "knt1a", title: "Flight BOM/PNQ to Dehradun (2h 15m)", description: "Direct morning flight to Dehradun (DED), met by pre-arranged private mountain cab.", location: { name: "Dehradun Airport", lat: 30.1897, lng: 78.1803 }, type: "transport" },
          { _key: "knt1b", title: "Scenic Drive to Kanatal via Chamba (~85 km, 2.5 hrs)", description: "Smooth winding highway ascending through misty pine canopies with glimpses of Tehri hills.", location: { name: "Kanatal", lat: 30.4184, lng: 78.3444 }, type: "transport" },
          { _key: "knt1c", title: "Sunset Deck Check-in & Pahadi Chai", description: "Unpack at a cozy wooden cottage or luxury safari camp with sweeping views of the Garhwal range.", location: { name: "Kanatal Ridge", lat: 30.4184, lng: 78.3444 }, type: "accommodation" },
        ],
      },
      {
        _key: "knt-d2",
        ...
        activities: [
          { _key: "knt2a", title: "Kaddukhal Base & Trailhead Ascent (2 km, 1 hr)", description: "Steep but well-paved trail lined with pine trees and brass temple bells (ropeway option available).", location: { name: "Kaddukhal", lat: 30.4120, lng: 78.2910 }, type: "activity" },
          { _key: "knt2b", title: "Surkhanda Devi Temple Darshan & Summit View", description: "Ancient temple dedicated to Goddess Sati perched at 3,048 m with panoramic views of the Greater Himalayas.", location: { name: "Surkhanda Devi Temple", lat: 30.4147, lng: 78.2867 }, type: "sightseeing" },
          { _key: "knt2c", title: "Traditional Garhwali Chainsoo Lunch", description: "Enjoy hot local mountain lentils, tawa rotis with homemade white butter, and rhododendron buransh squash.", location: { name: "Milan Dhaba, Kanatal", lat: 30.4184, lng: 78.3444 }, type: "food" },
        ],
      },
      {
        _key: "knt-d3",
        ...
        activities: [
          { _key: "knt3a", title: "Kaudia Forest Reserve Nature Walk (6 km)", description: "Flat, tranquil dirt track through towering deodars and natural freshwater springs.", location: { name: "Kaudia Forest", lat: 30.4280, lng: 78.3580 }, type: "activity" },
          { _key: "knt3b", title: "Picnic & Wood-Fired Pizza at Kaudia Cafe", description: "Relax at the forest edge eco-cafe sampling fresh herb tea and wood-fired pizzas.", location: { name: "Kaudia Nature Cafe", lat: 30.4280, lng: 78.3580 }, type: "food" },
          { _key: "knt3c", title: "Tehri Lake Panoramic Viewpoint", description: "Short detour to overlook the massive emerald reservoir of Tehri Dam nestled between mountain folds.", location: { name: "Tehri Dam Viewpoint", lat: 30.3780, lng: 78.4800 }, type: "sightseeing" },
        ],
      },
      {
        _key: "knt-d4",
        ...
        activities: [
          { _key: "knt4a", title: "Dhanaulti Eco Park Walk (Amber & Dhara)", description: "Peaceful forest park preserved by local youth cooperatives with winding paths and flying fox lines.", location: { name: "Dhanaulti Eco Park", lat: 30.4500, lng: 78.2400 }, type: "activity" },
          { _key: "knt4b", title: "Descent to Jolly Grant Airport (~75 km, 2.5 hrs)", description: "Scenic mountain downhill drive back to Dehradun Airport.", location: { name: "Dehradun Airport", lat: 30.1897, lng: 78.1803 }, type: "transport" },
          { _key: "knt4c", title: "Flight back to Mumbai (BOM) / Pune (PNQ)", description: "Board direct flight home feeling refreshed by the pure Himalayan pine air.", location: { name: "Mumbai Airport", lat: 19.0896, lng: 72.8656 }, type: "transport" },
        ],
      },
    ],
  },
    ...
    itinerary: [
      {
        ...
        activities: [
          { _key: "chk1a", title: "Flight BOM/PNQ to Pantnagar (PGH)", description: "Direct morning flight landing in Kumaon gateway plains.", location: { name: "Pantnagar Airport", lat: 29.0322, lng: 79.4736 }, type: "transport" },
          { _key: "chk1b", title: "Drive to Chaukori via Almora (~185 km, 6.5 hrs)", description: "Scenic drive ascending through pine ridges, terrace valleys, and the historic cultural town of Almora.", location: { name: "Chaukori", lat: 29.8710, lng: 80.0210 }, type: "transport" },
          { _key: "chk1c", title: "Check-in at KMVN Tea Estate Cottage", description: "Unwind at the heritage British tea garden rest house with direct view of snowy peaks from the lawn.", location: { name: "Chaukori Tea Estate", lat: 29.8710, lng: 80.0210 }, type: "accommodation" },
        ],
      },
      {
        _key: "chk-d2",
        ...
        activities: [
          { _key: "chk2a", title: "Sunrise at Chaukori Watch Tower", description: "Climb the watchtower for one of the widest unbroken Himalayan views in India, stretching across 300 km of peaks.", location: { name: "Chaukori Watch Tower", lat: 29.8720, lng: 80.0220 }, type: "sightseeing" },
          { _key: "chk2b", title: "Heritage Tea Garden Walking Tour", description: "Stroll among tea bushes planted by British planters in the late 19th century and visit local processing sheds.", location: { name: "Chaukori Tea Gardens", lat: 29.8710, lng: 80.0210 }, type: "activity" },
          { _key: "chk2c", title: "Kumaoni Feast with Local Tea", description: "Taste authentic Bhatt ki Dal, Singori sweet in Malu leaves, and freshly brewed organic Chaukori green tea.", location: { name: "Tea Garden Kitchen, Chaukori", lat: 29.8710, lng: 80.0210 }, type: "food" },
        ],
      },
      {
        _key: "chk-d3",
        ...
        activities: [
          { _key: "chk3a", title: "Drive to Patal Bhuvaneshwar (35 km, 1.2 hrs)", description: "Scenic drive descending into the Saryu river basin to the cave complex entry.", location: { name: "Patal Bhuvaneshwar", lat: 29.6917, lng: 80.0917 }, type: "transport" },
          { _key: "chk3b", title: "Underground Limestone Cave Exploration", description: "Descend narrow iron chains into the subterranean chamber to witness natural stone sculptures described in Skanda Purana.", location: { name: "Patal Bhuvaneshwar Caves", lat: 29.6917, lng: 80.0917 }, type: "activity" },
          { _key: "chk3c", title: "Cave Base Dhaba Lunch & Return to Chaukori", description: "Steaming hot Dubuk dal, mountain pakoras, and ginger chai before returning for sunset.", location: { name: "Patal Bhuvaneshwar Village", lat: 29.6917, lng: 80.0917 }, type: "food" },
        ],
      },
      {
        _key: "chk-d4",
        ...
        activities: [
          { _key: "chk4a", title: "Berinag Serpent Temples & Tea Gardens", description: "Visit the revered Snake temples of Berinag surrounded by rolling pine forests and tea slopes.", location: { name: "Berinag", lat: 29.8000, lng: 80.0500 }, type: "sightseeing" },
          { _key: "chk4b", title: "Hat Kalika Temple, Gangolihat", description: "Historic 8th-century temple complex dedicated to Goddess Kali, deeply revered by the Indian Army's Kumaon Regiment.", location: { name: "Gangolihat", lat: 29.6600, lng: 80.0400 }, type: "activity" },
          { _key: "chk4c", title: "Bonfire & Star Gazing Night at Chaukori", description: "Evening campfire under crystal clear Himalayan night skies with Orion and the Milky Way glistening above Nanda Devi.", location: { name: "Chaukori Ridge", lat: 29.8710, lng: 80.0210 }, type: "accommodation" },
        ],
      },
      {
        _key: "chk-d5",
        ...
        activities: [
          { _key: "chk5a", title: "Jageshwar Dham Temple Complex (85 km, 2.5 hrs)", description: "Enchanting 8th-to-12th century stone temple cluster dedicated to Lord Shiva set deep within towering deodar woods.", location: { name: "Jageshwar Dham", lat: 29.6400, lng: 79.8500 }, type: "sightseeing" },
          { _key: "chk5b", title: "Drive to Kathgodam / Pantnagar Airport (~115 km, 3.5 hrs)", description: "Final descent to the railway terminal or airport.", location: { name: "Kathgodam", lat: 29.2730, lng: 79.5447 }, type: "transport" },
          { _key: "chk5c", title: "Return Flight to Mumbai (BOM) / Pune (PNQ)", description: "Board evening flight carrying home the tranquility and crisp mountain air of Kumaon.", location: { name: "Pantnagar Airport", lat: 29.0322, lng: 79.4736 }, type: "transport" },
        ],
      },
    ],
  },
