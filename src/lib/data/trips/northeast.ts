...
export const NORTHEAST_TRIPS: Trip[] = [
  ...
  {
    _id: "trip-tawang-7-days",
    title: "7 Days in Tawang — Asia's Largest Monastery, Sela Pass & Hidden Lakes",
    slug: "tawang-7-days",
    excerpt:
      "From Delhi to Arunachal Pradesh — cross the dramatic Sela Pass at 13,700 ft, stand at Asia's second-largest Buddhist monastery, walk frozen lake shores at Madhuri Lake, and explore the spiritual heartland of the Monpa people in India's most remote frontier.",
    tags: ["Northeast", "Arunachal", "Tawang", "Mountains", "Buddhism", "Culture", "Adventure", "High Altitude", "India"],
    country: "India",
    bestSuggestedMonth: "March – June & September – November",
    status: "published",
    viewCount: 0,
    totalBudget: 35000,
    currency: "INR",
    tripType: "Mountain/Culture",
    difficulty: "Moderate",
    readingTime: 14,
    _createdAt: "2026-09-16T00:00:00Z",
    _updatedAt: "2026-09-16T00:00:00Z",
    coverImage: undefined,
    itinerary: [
      {
        _key: "tw-day1",
        dayNumber: 1,
        title: "Delhi → Guwahati (Flight) → Bhalukpong",
        date: undefined,
        summary: "Fly from Delhi to Guwahati (approx. 2.5 hrs), then road-transfer to Bhalukpong — the gateway to Arunachal Pradesh — crossing through lush jungle and the Kameng River gorge.",
        activities: [
          {
            _key: "tw1a",
            title: "Early Morning Flight: Delhi → Guwahati",
            description: "Take the 5–6 AM flight from Delhi (IGI) to Guwahati (LGB). Flight duration ~2.5 hrs. Book at least 4–6 weeks in advance for best fares (IndiGo/Air India ~₹3,000–5,000 one-way).",
            location: { name: "Indira Gandhi International Airport, Delhi", lat: 28.5562, lng: 77.1000 },
            type: "transport",
            time: "05:00 AM",
          },
          {
            _key: "tw1b",
            title: "Pickup & Drive Guwahati → Bhalukpong",
            description: "Pre-booked cab (~4 hrs, 185 km via NH-27). Cross the Assam–Arunachal border at Bhalukpong. ILP (Inner Line Permit) check-post here — ensure ILP is ready before arrival.",
            location: { name: "Bhalukpong, Arunachal Pradesh", lat: 27.0173, lng: 92.6478 },
            type: "transport",
            time: "10:00 AM",
          },
          {
            _key: "tw1c",
            title: "ILP Verification & Kameng River Walk",
            description: "ILP for Arunachal Pradesh is mandatory for Indian nationals. Apply online at https://arunachal.nic.in/ at least 5 days prior. Walk along the Kameng River bank at dusk.",
            type: "activity",
            time: "04:00 PM",
          },
          {
            _key: "tw1d",
            title: "Overnight at Bhalukpong",
            description: "Check into hotel at Bhalukpong (1,700 ft). Dinner at hotel or local restaurant.",
            location: { name: "Bhalukpong", lat: 27.0173, lng: 92.6478 },
            type: "accommodation",
            time: "06:00 PM",
          },
        ],
      },
      {
        _key: "tw-day2",
        dayNumber: 2,
        title: "Bhalukpong → Bomdila (2,415 m)",
        date: undefined,
        summary: "Drive through forested mountain roads from Bhalukpong to Bomdila — a Monpa tribal town with an ancient monastery, apple orchards, and sweeping views of the Eastern Himalayas.",
        activities: [
          {
            _key: "tw2a",
            title: "Drive Bhalukpong → Tipi → Bomdila",
            description: "Scenic 3–4 hr drive (96 km via Tipi Orchid Research Centre). Pass through Rupa and Tenga valleys.",
            type: "transport",
            time: "07:00 AM",
          },
          {
            _key: "tw2b",
            title: "Tipi Orchid Research Centre (En Route)",
            description: "One of India's richest orchid gardens with 500+ orchid species. Quick 30-min visit — open October to April for best blooms.",
            location: { name: "National Orchid Research Centre, Tipi", lat: 27.0700, lng: 92.7600 },
            type: "sightseeing",
            time: "09:00 AM",
          },
          {
            _key: "tw2c",
            title: "Bomdila Monastery (Gentse Gaden Rabgyel Ling)",
            description: "Three-tiered monastery with impressive Himalayan views from its terrace. Contains relics, thangkas, and giant Buddha statues. One of the most important Nyingma sect monasteries in the region.",
            location: { name: "Bomdila Monastery, West Kameng", lat: 27.2650, lng: 92.4135 },
            type: "sightseeing",
            time: "01:00 PM",
          },
          {
            _key: "tw2d",
            title: "Bomdila Market & Craft Centre",
            description: "Browse Monpa tribal handicrafts — woven carpets, cane baskets, thangka paintings. Bomdila is the best place in Arunachal to buy authentic local handicrafts.",
            type: "activity",
            time: "04:00 PM",
          },
          {
            _key: "tw2e",
            title: "Overnight at Bomdila",
            description: "Stay at Bomdila (2,415 m / 7,923 ft). Acclimatize gently — walk slowly and stay hydrated.",
            location: { name: "Bomdila", lat: 27.2650, lng: 92.4135 },
            type: "accommodation",
            time: "05:30 PM",
          },
        ],
      },
      {
        _key: "tw-day3",
        dayNumber: 3,
        title: "Bomdila → Dirang → Sela Pass → Tawang",
        date: undefined,
        summary: "The most dramatic driving day — cross Sela Pass at 13,700 ft through snow and cloud, stop at the sacred Sela Lake, and arrive in Tawang after one of the most thrilling mountain drives in India.",
        activities: [
          {
            _key: "tw3a",
            title: "Early Start: Bomdila → Dirang",
            description: "Depart by 6:30 AM for Dirang (~1.5 hrs, 42 km). Stop at Dirang Dzong (a 17th-century fortified village) and Sangti Valley viewpoint.",
            location: { name: "Dirang, West Kameng", lat: 27.3500, lng: 92.2300 },
            type: "transport",
            time: "06:30 AM",
          },
          {
            _key: "tw3b",
            title: "Sela Pass (4,170 m / 13,700 ft)",
            description: "One of the highest motorable passes in the world. At the summit: Sela Lake (partially frozen year-round), an Indian Army war memorial, and panoramic snow views. Drive slowly due to altitude — no rushing. Carry warm layers (it can be -5°C even in summer).",
            location: { name: "Sela Pass, Tawang District", lat: 27.5093, lng: 92.0742 },
            type: "sightseeing",
            time: "09:00 AM",
          },
          {
            _key: "tw3c",
            title: "Jaswantgarh War Memorial",
            description: "Memorial to Rifleman Jaswant Singh Rawat, who single-handedly held back Chinese forces for 72 hours in the 1962 war. A deeply moving stop — the army still serves him meals ceremonially.",
            location: { name: "Jaswantgarh War Memorial", lat: 27.6002, lng: 92.0050 },
            type: "sightseeing",
            time: "11:30 AM",
          },
          {
            _key: "tw3d",
            title: "Arrive Tawang Town",
            description: "Check-in at hotel. Rest and acclimatize to 3,048 m altitude. Evening stroll through the market — try butter tea and thukpa at a local restaurant.",
            location: { name: "Tawang", lat: 27.5860, lng: 91.8594 },
            type: "accommodation",
            time: "03:00 PM",
          },
        ],
      },
      {
        ...
        date: undefined,
        summary: "The centrepiece of the journey — Asia's second-largest Buddhist monastery (after Lhasa's Drepung), the birthplace of the 6th Dalai Lama, and Tawang's ancient hilltop market. A day of deep spiritual and cultural immersion.",
        activities: [
          {
            _key: "tw4a",
            title: "Tawang Monastery (Galden Namgey Lhatse)",
            description: "Founded in 1681 by Merak Lama Lodre Gyatso. At 3,500 m, it houses 500+ monks, ancient scriptures, giant Buddha statue, and thangka museum. Arrive by 8 AM for the morning prayers — the chanting echoes through the valleys. Photography allowed in outer courtyards.",
            location: { name: "Tawang Monastery, Arunachal Pradesh", lat: 27.5906, lng: 91.8622 },
            type: "sightseeing",
            time: "08:00 AM",
          },
          {
            ...
            description: "Stupa-shaped war memorial for soldiers of the 1962 Indo-China War. Offers sweeping views of the entire Tawang valley. Well-maintained with a museum section.",
            location: { name: "Tawang War Memorial", lat: 27.5820, lng: 91.8667 },
            type: "sightseeing",
            time: "11:00 AM",
          },
          {
            _key: "tw4c",
            title: "Tawang Market & Craft Shopping",
            description: "Buy local Monpa handwoven carpets, yak wool products, and traditional masks. The Sunday market (if applicable) draws tribal sellers from surrounding villages.",
            type: "activity",
            time: "01:00 PM",
          },
          {
            ...
            description: "Birthplace of the 6th Dalai Lama, Tsangyang Gyatso. A small but historically significant monastery 6 km from Tawang town. Often quiet — ideal for peaceful reflection.",
            location: { name: "Urgelling Monastery, Tawang", lat: 27.5659, lng: 91.8600 },
            type: "sightseeing",
            time: "03:30 PM",
          },
        ],
      },
      {
        _key: "tw-day5",
        dayNumber: 5,
        title: "Madhuri Lake, PT Tso & Bumla Pass (optional)",
        date: undefined,
        summary: "Full-day excursion to the high-altitude lakes circuit — the stunning Shungetser (Madhuri) Lake, the army-restricted Bumla border pass with China, and PT Tso (Pangateng Tso) for sunrise reflections.",
        activities: [
          {
            _key: "tw5a",
            title: "Shungetser / Madhuri Lake (4,000 m)",
            description: "Crystal-clear glacial lake formed by a 1950 earthquake. Surrounded by snow peaks and yak pastures. Known as Madhuri Lake after filming here for a Bollywood sequence. Army-restricted zone — permits arranged by local agents (₹500–800 pp).",
            location: { name: "Madhuri Lake, Tawang", lat: 27.7256, lng: 91.8920 },
            type: "sightseeing",
            time: "07:00 AM",
          },
          {
            _key: "tw5b",
            title: "PT Tso (Pangateng Tso) Lake",
            description: "High-altitude twin lake with mirror reflections of the Himalayas. Less visited than Madhuri — even more tranquil. Musk deer are sometimes spotted on the shores.",
            location: { name: "PT Tso, Tawang", lat: 27.7450, lng: 91.9350 },
            type: "sightseeing",
            time: "09:30 AM",
          },
          {
            _key: "tw5c",
            title: "Bumla Pass (4,563 m) — India–China Border",
            description: "Optional (requires Special Area Permit from DC Office, Tawang — apply 1 day prior). The actual India–China border from the 1962 war. Indian Army escorts mandatory. Stunning but stark landscape. Only accessible May–October when road is snow-free.",
            location: { name: "Bumla Pass, Arunachal Pradesh", lat: 27.7500, lng: 91.9800 },
            type: "activity",
            time: "11:00 AM",
          },
          {
            _key: "tw5d",
            title: "Return to Tawang, Rest & Evening Monastery Prayer",
            description: "Return to Tawang by 3 PM. Evening prayer session at Tawang Monastery open to visitors — deeply moving experience at dusk.",
            type: "sightseeing",
            time: "05:00 PM",
          },
        ],
      },
      {
        _key: "tw-day6",
        dayNumber: 6,
        title: "Tawang → Bomdila (Return)",
        date: undefined,
        summary: "Begin the return journey — cross Sela Pass again (often even more dramatic in afternoon light), stop at Nuranang Falls ('Jang Falls') en route, and overnight in Bomdila.",
        activities: [
          {
            _key: "tw6a",
            title: "Depart Tawang → Sela Pass",
            description: "Early departure (7 AM) to cross Sela Pass before afternoon cloud build-up. Take a final look at the Tawang valley at the first hairpin bend.",
            type: "transport",
            time: "07:00 AM",
          },
          {
            _key: "tw6b",
            title: "Nuranang Falls (Jang Falls)",
            description: "Spectacular 100-metre-tall waterfall near Jang town, made famous by the Bollywood film 'Koyla'. A short 10-min walk from the road. Best in post-monsoon (Sept–Nov) for full flow.",
            location: { name: "Nuranang Falls (Jang Falls), Tawang", lat: 27.6240, lng: 92.0300 },
            type: "sightseeing",
            time: "10:00 AM",
          },
          {
            _key: "tw6c",
            title: "Lunch at Dirang",
            description: "Hot lunch in Dirang (~1 PM). Try the apple juice and local pork curry at roadside restaurants near the market.",
            location: { name: "Dirang", lat: 27.3500, lng: 92.2300 },
            type: "food",
            time: "01:00 PM",
          },
          {
            _key: "tw6d",
            title: "Arrive Bomdila, Overnight",
            description: "Check-in at Bomdila. Evening walk through the local market. Dinner at hotel.",
            location: { name: "Bomdila", lat: 27.2650, lng: 92.4135 },
            type: "accommodation",
            time: "04:00 PM",
          },
      ...
      },
      {
        _key: "tw-day7",
        dayNumber: 7,
        title: "Bomdila → Guwahati → Delhi (Flight)",
        date: undefined,
        summary: "Final morning — drive down from Bomdila through the Arunachal foothills to Guwahati Airport (4–5 hrs), then fly back to Delhi in the evening.",
        activities: [
          {
            _key: "tw7a",
            title: "Early Drive: Bomdila → Guwahati",
            description: "Depart by 6 AM for the 195 km drive to Guwahati (4.5–5.5 hrs). Cross the Arunachal border at Bhalukpong. Roads are good below Bomdila.",
            type: "transport",
            time: "06:00 AM",
          },
          {
            _key: "tw7b",
            title: "Kamakhya Temple (En Route, Optional)",
            description: "Stop at the powerful Kamakhya Shakti Peeth on the banks of the Brahmaputra if time permits (add 1 hr). One of India's most important Tantric temples.",
            location: { name: "Kamakhya Temple, Guwahati", lat: 26.1664, lng: 91.7085 },
            type: "activity",
            time: "12:00 PM",
          },
          {
            _key: "tw7c",
            title: "Evening Flight: Guwahati → Delhi",
            description: "Take the 5–7 PM flight back to Delhi (Lok Priya Gopinath Bordoloi International Airport). Book 4–6 weeks in advance for best fares. Flight duration ~2.5 hrs.",
            location: { name: "Lokpriya Gopinath Bordoloi Airport, Guwahati", lat: 26.1061, lng: 91.5859 },
            type: "transport",
            time: "05:00 PM",
          },
        ],
